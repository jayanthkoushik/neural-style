...
train_arg_parser.add_argument("--content-weight", type=float, default=5.)
train_arg_parser.add_argument("--style-weight", type=float, default=6e-4)
...
train_arg_parser.add_argument("--lr-decay", type=float, default=2e-3)
